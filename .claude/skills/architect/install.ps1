# Установка скилла architect из репозитория OverGate в локальную папку плагинов Claude.
# Запуск:
...
$Src = $PSScriptRoot
$Dest = "$env:APPDATA\Claude\local-agent-mode-sessions\skills-plugin\895eadaa-7627-4e16-a251-a6569dc507c4\71b9303c-6821-4825-9aae-ddf7d998e891\skills\architect"
